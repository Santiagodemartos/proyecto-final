...
class Bullet(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load("assets/bonba.png")
		self.image.set_colorkey(BLACK)
		self.rect = self.image.get_rect()
		self.rect.y = y
		self.rect.centerx = x
...
def show_go_screen():
	...
	draw_text(screen, "Disparar", 65, WIDTH // 2, HEIGHT // 4)
	draw_text(screen, "Proyecto final. Los del fondo", 27, WIDTH // 2, HEIGHT // 2)
